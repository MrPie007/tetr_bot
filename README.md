...
piece. Movement inputs are separated by 1 ms, and capture waits 20 ms after a
hard drop so the game can render its next frame. The previous one-second loop
